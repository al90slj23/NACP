			...
			if shouldSelectChannel {
				...
				if preferredChannelID, found := service.GetPreferredChannelByAffinity(c, modelRequest.Model, usingGroup); found {
					...
					if err == nil && preferred != nil {
						...
						} else if !service.IsChannelRoutable(preferred.Id) {
							// NACP: Affinity channel is Degraded — skip affinity, use normal selection
							// Don't set SkipRetry flag, allow retry on other channels
							// SwitchOnSuccess will update affinity cache to the new channel
